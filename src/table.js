...
const Table = () => {
  ...
  return (
    ...
    <input className='outline-none font-bold border-b border-blue-800'
    ...
    {tableData().map(product => {
      ...
      <table class="table-auto w-full text-2xl text-blue-800">
          ...
          <tr> <td><img class="w-14 h-14 mx-auto object-cover border-2 border-blue-600 rounded-xl"src={product.image}/></td>
